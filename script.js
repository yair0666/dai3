    ...
    function generateMessage(name) {
        const moodMessages = {
            feliz: [
                ...
                "Te amo",
                "Pues si tan feliz ven y dame unos besotes",
                "Apoco si ajajaja ps echale ganas no?",
                "Pues gpi un abasote porfa",
                "Jajaja y ahora q pongo, bno, m alegra q andes japi",
                "La jelo kiti esta orgullosa de ti",
                "Me alegra que estes japi, estoy orgullos de ti",
                "Yo tmb estoy feliz, hay q besarnos",
                "Como dijo el mikimaus q bn q bn q todo esta bien ajajaja",
        ...
        if (mood && moodMessages[mood]) {
            ...
            return `Siempre te apoyaré y estaré aquí para ti. Recuerda que te quiero muchito, mi Dairita ❤️`;
        }
    }
});
